			...
			<div class="row">
				<div class="col-lg-12 no-gutters">
					...
					<div class="pos-f-t no-gutters">
						...
						<div class="collapse bg-negro" id="navbarToggleExternalContent">
							<div class="p-4">
								<ul class="menu navbar-nav">
									<li class="item-menu"><a href="#" class="nav-link">Productos móviles</a></li>
	...
	<div class="main">
		...
		<section class="catalogos">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-2 col-md-4 col-sm-6 col-6"><img src="assets/catalogo1.png" class="img-fluid"><p>Productos móviles</p></div>
					<div class="col-lg-2 col-md-4 col-sm-6 col-6"><img src="assets/catalogo2.png" class="img-fluid"><p>Equipos</p></div>
					<div class="col-lg-2 col-md-4 col-sm-6 col-6"><img src="assets/catalogo3.png" class="img-fluid"><p>Olo</p></div>
					<div class="col-lg-2 col-md-4 col-sm-6 col-6"><img src="assets/catalogo4.png" class="img-fluid"><p>Claro Hogar</p></div>
					<div class="col-lg-2 col-md-4 col-sm-6 col-6"><img src="assets/catalogo5.png" class="img-fluid"><p>Claro Negocios</p></div>
					<div class="col-lg-2 col-md-4 col-sm-6 col-6"><img src="assets/catalogo6.png" class="img-fluid"><p>Valor agregado</p></div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-10 mx-auto">
						<div class="row">
							<div class="col-lg-8 mt-3 col-sm-7 mx-auto col-11">
